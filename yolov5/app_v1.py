...
def detect_objects_endpoint():
    opt = parse_opt()  # Panggil parse_opt di sini untuk mendapatkan nilai opt yang diperlukan
    ...
    temp_image_path = 'data/images/temp_image.jpg'
    ...
    # Jalankan fungsi run
    detection_results = run(**vars(opt))

    # Hapus gambar sementara setelah deteksi selesai
    os.remove(temp_image_path)

    # Deteksi selesai, Anda dapat mengirimkan respons apa pun yang sesuai di sini
